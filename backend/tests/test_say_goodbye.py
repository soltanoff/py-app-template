...
def test_returns_dictionary_with_greeting_message():
    ...
    # Act
    result = service.say_goodbye(name)

    # Assert
    assert isinstance(result, dict)
    assert "message" in result
    assert result["message"] == "Goodbye John"
...
def test_formats_greeting_with_provided_name():
    ...
    # Assert
    assert result["message"] == "Goodbye Alice"
...
def test_handles_multi_word_names():
    ...
    # Assert
    assert result["message"] == "Goodbye John Doe"
...
def test_handles_very_long_name_inputs():
    ...
    # Assert
    assert result["message"] == f"Goodbye {'A' * 1000}"
...
def test_handles_special_characters_in_name():
    ...
    # Assert
    assert result["message"] == "Goodbye John@#$%^&*()_+"
...
def test_handles_numeric_characters_in_name():
    ...
    # Assert
    assert result["message"] == "Goodbye User123"
...
def test_handles_non_ascii_characters():
    ...
    # Assert
    assert result["message"] == "Goodbye José 😊"
